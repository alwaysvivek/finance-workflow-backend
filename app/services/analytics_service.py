...
class AnalyticsService:
    ...
    def get_total_spend(self, current_user: User) -> float:
    ...
    def get_category_breakdown(self, current_user: User) -> List[Dict[str, Any]]:
    ...
    def get_monthly_trends(self, current_user: User) -> List[Dict[str, Any]]:
    ...
    def get_approval_rate(self, current_user: User) -> Dict[str, int]:
